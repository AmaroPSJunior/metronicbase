    ...
    <Portlet>
      ...
      <PortletBody>
          ...
          <li>
            ...
            <CodeBlock
              ...
              code={`
                ...
                - addLocaleData([...de, ...en, ...pt, ...es, ...fr, ...ja, ...zh]);
                + addLocaleData([...de, ...en, ...pt, ...es, ...fr, ...ja, ...zh, ...tr]);
        ...
        <p>
          ...
          <code>src/_metronic/i18n/messages/pt.json</code>. This means that you
          can have a translation that looks like this:
        </p>

        <ol>
          <li>
            Add translation to <code>src/app/i18n/pt.json</code>:
            <CodeBlock
              language="json"
              code={`
                {
